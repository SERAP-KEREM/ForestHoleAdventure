...
namespace _Main._Objects
{
    ...
    public class CollectibleItem : MonoBehaviour
    {
        ...
        [Group("Collection Animation Settings")]
        [SerializeField, PropertyTooltip("The duration of the collection animation.")]
        private float _collectDuration = 2f;

        [SerializeField, PropertyTooltip("The depth at which the item falls during collection animation.")]
        private float _fallDepth = 0.5f;

        [SerializeField, PropertyTooltip("The duration for fading the collectible item.")]
        private float _fadeDuration = 1.5f;

        [Group("Object Settings")]
        [SerializeField, PropertyTooltip("The type of collectible item, used to determine score.")]
